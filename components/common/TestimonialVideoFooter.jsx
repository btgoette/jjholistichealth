  ...
  return (
    <section className="testimonial-video-section pt-0">
      ...
      <Container>
        ...
        <Row>
          <Link className="mx-auto" href="/about/testimonials" passHref>
            <Button className="mx-auto">See All Our Reviews</Button>
          </Link>
        </Row>
      </Container>
    </section>
...
export default TestimonialVideoFooter;
