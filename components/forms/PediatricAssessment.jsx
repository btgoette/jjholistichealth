...
export default function PediatricAssessment() {
  ...
  return (
    <form id="pediatricAssessment" method="POST" action="https://usebasin.com/f/5eeeb6469f20">
      ...
      <label>Please list the ages of your parents and grandparents. If a family member is deceased, please write their age of death and cause (if known).</label><br />
      <fieldset>
        <div>
