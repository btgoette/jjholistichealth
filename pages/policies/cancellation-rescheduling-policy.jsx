                        ...
                        <Col>
                            <div className="cancellation-us-block">
                                <div className="cancellation">
                                    ...
                                    <p>Appointments are in high demand, and we require a <strong>$75 Upfront Fee for the Initial Interview</strong> and a <strong>$25 Upfront Fee for the succeeding appointments.</strong> This is to secure your appointment and it will serve as a partial payment of the service fee. It will be deducted on the day of the actual appointment. </p>
                                    ...
                                    <p>If you <strong>fail to show up</strong> in your scheduled appointment, have <strong>no advice to reschedule 24 hrs ahead</strong> of the scheduled appointment, are <strong>15 minutes late</strong> or <strong>notification to reschedule or cancellation of the appointment is less than 24 hours</strong>, a <strong>No Show Fee</strong> of <strong>$25 will apply.</strong> </p>
                                    ...
                                    <p>
                                        <em>
                                            * All J&amp;J All In Wellness Plans must be paid in full before or after the Initial Interview.
                                            <br />
                                            * We accept cash, all major credit cards, HSA card, or FLEX Spending
                                            <br />
                                            * 20% Veteran discount
                                            <br />
                                        </em>
