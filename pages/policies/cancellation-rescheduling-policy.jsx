        ...
        <Row className="custom-row">
          <Col lg={{ offset: 2, span: 8, order: 0 }}>
            ...
            <p>
              ...
              <strong>$75 Upfront Fee for the Initial Interview</strong> and a{" "}
              <strong> $25 Upfront Fee for the succeeding appointments.</strong>{" "}
              This is to secure your appointment and it will serve as a partial
              payment of the service fee. It will be deducted on the day of the
              actual appointment.
            </p>
            <h2>Cancellation or Rescheduling</h2>
            <p>
              Let us know at least 24 hours in advance if you cannot attend the
              appointment, as it will give way to someone who urgently needs
            ...
            <p>
              ...
              <strong>
                {" "}
                notification to reschedule or cancellation of the appointment is
                less than 24 hours,
              </strong>{" "}
              a <strong>No Show Fee</strong> of <strong>$25 will apply.</strong>
            </p>
            <p>
              For first-time clients who paid the $75 Upfront Fee, we will be
              deducting the $25 and we will refund the $50, and for those who
              paid a $25 Upfront Fee, it will be forfeited.
            </p>
            <p>
            ...
            <p>
              ...
              minutes it will be considered as No Show and we will re-schedule
              your appointment.
            </p>
            <p>
              <strong>
                To Cancel or Reschedule your appointment, you can do any of the
                following:
              </strong>
            </p>
            <ul>
            ...
            <p>
              <em>
                * All J&amp;J All In Wellness Plans must be paid in full before
