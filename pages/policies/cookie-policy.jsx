    ...
    return (
        ...
        <>
            ...
            <div className="cookie-policy">
                ...
                <Container fluid className="cookie-section">
                    <Container>
                        <Breadcrumbs {...content} />
                        <Row className="custom-row">
                            <Col>
                                <div className="cookie-us-block">
                                    <div className="cookie">
                                        ...
                                        <ul>
                                            <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to J &amp; J Holistic Nutritional Therapy LLC, 4645 Avon Ln Suite 340 Frisco, TX 75033, USA..</li>
                                            <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
                                            <li><strong>Website</strong> refers to J &amp; J Holistic Nutritonal Therapy, accessible from <Link href="/">jjholistichealth.com</Link></li>
